...
class Planar3Body :
    ...
    G = 4 * math.pi**2 / (m1 + m2 + m3)#248363527.3           #4 * math.pi**2  #/ (m1 + m2 + m3)      set

    def __init__( self, m1, m2, m3 ):
        self.m1 = m1
        self.m2 = m2
        self.m3 = m3
        self.G = 4 * math.pi**2 / (m1 + m2 + m3)#248363527.3#4 * math.pi**2 #/ (m1 + m2 + m3)
    ...
    def __call__(self, trv ) :
        ...
        #ax1 = - self.G * self.m2 * (x1 - x2) / r12**3 - self.G * self.m3 * (x1 - x3) / r13**3         #real
        #ay1 = - self.G * self.m2 * (y1 - y2) / r12**3 - self.G * self.m3 * (y1 - y3) / r13**3         #real
        ...
        ax3 = 0#- self.G * self.m1 * (x3 - x1) / r13**3 - self.G * self.m2 * (x3 - x2) / r23**3
        ay3 = 0#- self.G * self.m1 * (y3 - y1) / r13**3 - self.G * self.m2 * (y3 - y2) / r23**3
